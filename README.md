...
Обладает нативной поддержкой в HA. Проверка длинны ввода отсутвует в данном варианте. 
Работа с числами и английскими словами максимально упрощенная (внутри speech_tts), лишь бы не мычал.
```
# Установите требуемые билилиотеки (см. ниже)
